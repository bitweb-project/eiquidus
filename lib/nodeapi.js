...
module.exports = function() {
  function express_app() {
    ...
    function specialApiCase(method_name, query_parameters) {
      ...
      switch (method_name) {
        ...
        case 'getmasternodecount':
        case 'getmasternodelist':
          let cmd = prepareRpcCommand(settings.api_cmds[method_name]);
        ...
        case 'getnextrewardwhenstr':
        case 'getsupply':
          let cmd = prepareRpcCommand(settings.blockchain_specific.heavycoin.api_cmds[method_name]);
        ...
        case 'getblockhash':
          ...
          let cmd = prepareRpcCommand(settings.api_cmds.getblockhash, params);
        ...
        case 'getblock':
          ...
          let cmd = prepareRpcCommand(settings.api_cmds.getblock, params);
        ...
        case 'getrawtransaction':
          ...
          let cmd = prepareRpcCommand(settings.api_cmds.getrawtransaction, params);
        ...
        case 'verifymessage':
          ...
          let cmd = prepareRpcCommand(settings.api_cmds.verifymessage, params);
  ...
  function setAccess(type, access_list) {
    ...
    if (type == 'default-safe') {
      let restrict_list = ['dumpprivkey', 'walletpassphrasechange', 'stop'];
    ...
    if (type == 'read-only') {
      let restrict_list = ['addmultisigaddress', 'addnode', 'backupwallet', 'createmultisig', 'createrawtransaction', 'encryptwallet', 'importprivkey', 'keypoolrefill', 'lockunspent', 'move', 'sendfrom', 'sendmany', 'sendrawtransaction', 'sendtoaddress', 'setaccount', 'setgenerate', 'settxfee', 'signmessage', 'signrawtransaction', 'stop', 'submitblock', 'walletlock', 'walletpassphrasechange'];
