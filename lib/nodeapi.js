  ...
  function express_app() {
    ...
    function specialApiCase(method_name, query_parameters) {
      ...
      switch (method_name) {
        ...
        case 'getmasternodecount':
        case 'getmasternodelist':
          cmd = prepareRpcCommand(settings.api_cmds[method_name]);
        ...
        case 'getblockhash':
          ...
          cmd = prepareRpcCommand(settings.api_cmds.getblockhash, params);
        ...
        case 'getblock':
          ...
          cmd = prepareRpcCommand(settings.api_cmds.getblock, params);
        ...
        case 'getrawtransaction':
          ...
          cmd = prepareRpcCommand(settings.api_cmds.getrawtransaction, params);
        ...
        case 'verifymessage':
          ...
          cmd = prepareRpcCommand(settings.api_cmds.verifymessage, params);
