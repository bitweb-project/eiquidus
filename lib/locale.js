...
exports.reloadLocale = function reloadLocale(locale) {
  ...
  for (const i in lsettings) {
    ...
    if (i.charAt(0).search("[a-z]") !== 0)
      console.warn(`${exports.localization.locale_lowercase_req}: '${i}'`);
    ...
    if (exports.localization[i] !== undefined) {
      ...
      console.warn(`${exports.localization.locale_unknown_string}: '${i}'. ${exports.localization.locale_not_exists}`);
    }
  }
